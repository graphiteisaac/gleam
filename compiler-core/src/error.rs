...
{required_version} and you are using v{gleam_version}"
    ...
    #[error("Publishing a blank package with only template code is not permitted")]
    CannotPublishBlankPackage,
...
"
            ...
            Error::CannotPublishBlankPackage => {
                let text =
                    "You appear to be attempting to publish a package that is blank, and only template code
generated by the Gleam tool. Please include some real code before attempting to publish.
"
                    .into();

                vec![Diagnostic {
                    title: "Package left blank for publishing".into(),
                    text,
                    level: Level::Error,
                    location: None,
                    hint: None,
